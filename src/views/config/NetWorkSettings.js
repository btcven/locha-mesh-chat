        ...
        >
          <View style={{
            ...
            <Text style={{
              ...
              Welcome to the network configuration, here you can change the connection path with the esp32 device or server
          </Text>
            <Form>
              <Text style={{ position: "absolute", top: "40%", right: "5%" }}></Text>
              <Item stackedLabel>
                <Input
